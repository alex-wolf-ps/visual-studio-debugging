    ...
    public class LoanCalculatorContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LoanApplicationResult>().HasData(
                ...
                new LoanApplicationResult() { ResultId = 9,  ApplicantType = "Premiere", FirstName = "Bob", LastName = "Stevens", AnnualIncome = 75_000, CreditScore = 790, Approved = true, InterestRate = 0.15, LoanAmount = 25_000, MonthlyPayment = 769.65, LoanTerm = 120 },
                ...
                new LoanApplicationResult() { ResultId = 10, ApplicantType = "Standard", FirstName = "Phil", LastName = "Tell", AnnualIncome = 60_000, CreditScore = 680, Approved = true, InterestRate = 0.075, LoanAmount = 135_000, MonthlyPayment = 934.94, LoanTerm = 120 },
                ...
                new LoanApplicationResult() { ResultId = 13, ApplicantType = "Standard", FirstName = "Jim", LastName = "Test", AnnualIncome = 133_000, CreditScore = 750, Approved = true, InterestRate = 0.05, LoanAmount = 150_000, MonthlyPayment = 1684.61, LoanTerm = 240 }
            );
        }
    }
}
